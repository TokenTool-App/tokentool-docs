...
## 第1步：验证令牌
1. 链接你的钱包。
2. 前往[https://tokentool.info/launchpad/create](https://tokentool.info/launchpad/create)
3. 输入您的令牌地址(如果您已经有了)，如果没有可以通过[一键发币](https://tokentool.info/createToken/V2)创建您的令牌
...
2. logo URL 必须已支持的图片扩展名结尾：png、jpg、jpeg、或者gif 。
   ...
   如果您没有在线图片url 可使用 [TokenTool IPFS](https://tokentool.info/other/ipfs)文件系统上传图片到IPFS中
